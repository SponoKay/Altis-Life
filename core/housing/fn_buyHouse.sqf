...
if(_action) then {
	if(R6cuXKTCWDZFxfbfdATm < (_houseCfg select 0)) exitWith {hint format [localize "STR_House_NotEnough"]};
	...
	R6cuXKTCWDZFxfbfdATm = R6cuXKTCWDZFxfbfdATm - (_houseCfg select 0);
