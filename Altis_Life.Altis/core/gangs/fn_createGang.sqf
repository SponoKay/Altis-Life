...
if(R6cuXKTCWDZFxfbfdATm < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-R6cuXKTCWDZFxfbfdATm)] call life_fnc_numberText];};
