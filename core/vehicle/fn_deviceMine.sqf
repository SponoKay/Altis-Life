...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","apple_5","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","cocaine_2","weed_1","weed_2","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","meth_1","meth_2"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["meth_1"]): {_gather = "phosphore"; _val = 1;};
