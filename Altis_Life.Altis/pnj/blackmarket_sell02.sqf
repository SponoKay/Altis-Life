/* 
	GarageLucel
	_null=this execVM "pnj\blackmarket_sell02.sqf";
*/
removeallweapons _this;
_this enableSimulation false; 
_this allowDamage false; 
_this addAction["<t color='#FF0000'>Vente de véhicule volé</t>",life_fnc_chopShopMenu,"chop_shop_1",0,false,false,"","!license_civ_mercenaire"];
