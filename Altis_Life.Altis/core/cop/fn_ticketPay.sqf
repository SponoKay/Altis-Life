...
if(hBf0MznDHQm7X5DFFSmy < life_ticket_val) exitWith
{
	if(R6cuXKTCWDZFxfbfdATm < life_ticket_val) exitWith 
	{
	...
	R6cuXKTCWDZFxfbfdATm = R6cuXKTCWDZFxfbfdATm - life_ticket_val;
...
hBf0MznDHQm7X5DFFSmy = hBf0MznDHQm7X5DFFSmy - life_ticket_val;
life_ticket_paid = true;
