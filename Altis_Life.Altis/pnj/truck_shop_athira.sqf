/* 
	CarshopLucel _null=this execVM "pnj\car_shop_athira.sqf";
*/
_this enableSimulation false; 
_this allowDamage false; 
_this addAction["<t color='#AAF200'>Concessionnaire Poids lourd</t>",
life_fnc_vehicleShopMenu,["civ_truck",civilian,["civ_truck_2","civ_truck_2_1"]
