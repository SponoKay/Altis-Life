...
_this addAction["<t color='#f6d359'>Assurance Bancaire (1000€)</t>",{if(life_atmcash > 1000) then {life_has_insurance = true; life_atmcash = life_atmcash - 1000};},"",0,false,false,"",'!life_has_insurance'];

_this addAction[format["%1 (%2€)",["license_civ_rebel"] call life_fnc_varToStr,[(["rebel"] call life_fnc_licensePrice)] call life_fnc_numberText],life_fnc_buyLicense,"rebel",0,false,false,"",' !license_civ_rebel && !license_civ_mercenaire && !license_civ_medecin && !license_civ_depanneur && !license_civ_taxi && playerSide == civilian '];
