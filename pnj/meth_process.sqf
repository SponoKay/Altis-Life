...
_this addAction["<t color='#FF9900'>Préparation Méthamphétamine</t>",life_fnc_processAction,"meth",0,false,false,"",' life_inv_phosphore > 0 && life_inv_soude > 0 && !life_is_processing'];
