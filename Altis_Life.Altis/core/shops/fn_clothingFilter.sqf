...
_clothes = switch (life_clothing_store) do
{
	...
	case "copciv": {[_selection] call life_fnc_clothing_copciv;};
	...
	case "merco": {[_selection] call life_fnc_clothing_merco;};
	case "medecin": {[_selection] call life_fnc_clothing_medecin;};
};
