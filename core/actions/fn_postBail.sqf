...
if(R6cuXKTCWDZFxfbfdATm < life_bail_amount) exitWith {hint format[localize "STR_NOTF_Bail_NotEnough",life_bail_amount];};

R6cuXKTCWDZFxfbfdATm = R6cuXKTCWDZFxfbfdATm - life_bail_amount;
life_bail_paid = true;
