...
_this addAction[format["%1 (%2€)",["license_civ_rebel"] call life_fnc_varToStr,[(["rebel"] call life_fnc_licensePrice)] call life_fnc_numberText],life_fnc_buyLicense,"rebel",0,false,false,"",' !license_civ_rebel && !license_civ_mercenaire && !license_civ_medecin && playerSide == civilian '];
